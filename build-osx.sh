...
java -jar packr_${PACKR_VERSION}.jar \
    ...
    Djna.nosys=true \
    --output \
    native-osx/Darkan.app

cp build/filtered-resources/Info.plist native-osx/Darkan.app/Contents
...
create-dmg --format UDBZ native-osx/Darkan.app.app native-osx/ || true
